package com.cityparking.pratteln.picker;
...
//	private static final int[] SHADOWS_COLORS = new int[] { 0xFF111111, 0x00AAAAAA, 0x00AAAAAA };
     ...
     */
    public void setCurrentItem(int index, boolean animated) throws NullPointerException {
    ...
    public void setCurrentItem(int index) {
        try {
            ...
            Log.e("---WheelView---", "Some error occurred: " + e.getMessage());
        }
    }
